...
//Usuario rerpresenta uma pessoa utilizando a rede social
type Usuario struct{
	ID 			uint64 				`json:"id"`
...
//BuscarUsuarioCompleto faz 4 requisicoes na API para montar o usuário
...
//BuscarSeguindo chama a API para buscar os usuários seguindo por um usuário
...
//BuscarPublicacoes chama a API para buscar as publicacões de um usuário
