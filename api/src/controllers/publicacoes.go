...
func DeletarPublicacao (w http.ResponseWriter, r *http.Request){
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID{
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível excluir uma publicacao que não seja sua"))
		return
	}
...
//BuscarPublicacoesPorUsuario traz todas as publicacaoes de um usuário especifico
